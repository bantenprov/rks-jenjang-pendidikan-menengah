    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/rks-jen-pen-mgh/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/rks-jen-pen-mgh/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/rks-jen-pen-mgh/create'
                  }
                },
                window.location.href = '#/admin/rks-jen-pen-mgh/create')
        ...
        back() {
            window.location = '#/admin/rks-jen-pen-mgh';
        }
    },
    mounted: function() {
        axios.get("/rks-jen-pen-mgh/create").then(response => {
